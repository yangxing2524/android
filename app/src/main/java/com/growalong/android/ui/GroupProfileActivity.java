...
public class GroupProfileActivity extends FragmentActivity implements GroupInfoView, View.OnClickListener {
    ...
    public void showGroupInfo(List<TIMGroupDetailInfo> groupInfos) {
        ...
        btnDel.setText(isGroupOwner && !type.equals("Private") ? getString(R.string.chat_setting_dismiss) : getString(R.string.chat_setting_quit));
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btnChat:
                ChatActivity.startThis(this,identify, TIMConversationType.Group, info.getGroupName());
                break;
            case R.id.btnDel:
