...
public class NonOffscreenViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
         ...
         * @see NonOffscreenViewPager#SCROLL_STATE_IDLE
         * @see NonOffscreenViewPager#SCROLL_STATE_DRAGGING
         * @see NonOffscreenViewPager#SCROLL_STATE_SETTLING
         */
    ...
    public NonOffscreenViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public NonOffscreenViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
