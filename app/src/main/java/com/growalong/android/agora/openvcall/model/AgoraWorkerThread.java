...
public class AgoraWorkerThread extends Thread {
    ...
    private AgoraEngineConfig mEngineConfig;

    public final AgoraEngineConfig getEngineConfig() {
        return mEngineConfig;
    }

    private final AgoraMyEngineEventHandler mEngineEventHandler;
    ...
    private RtcEngine ensureRtcEngineReadyLock() {
        if (mRtcEngine == null) {
            ...
            if (TextUtils.isEmpty(appId)) {
                throw new RuntimeException("NEED TO use your App ID, get your own ID at https://dashboard.com.growalong.android.agora.io/");
            }
            try {
            ...
            mRtcEngine.setLogFile(Environment.getExternalStorageDirectory()
                    + File.separator + mContext.getPackageName() + "/log/com.growalong.android.agora-rtc.log");
        }
        return mRtcEngine;
    }

    public AgoraMyEngineEventHandler eventHandler() {
    ...
    public AgoraWorkerThread(Context context) {
        ...
        this.mEngineConfig = new AgoraEngineConfig();
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        this.mEngineConfig.mUid = pref.getInt(AgoraConstantApp.PrefManager.PREF_PROPERTY_UID, 0);

        this.mEngineEventHandler = new AgoraMyEngineEventHandler(mContext, this.mEngineConfig);
    }
}
