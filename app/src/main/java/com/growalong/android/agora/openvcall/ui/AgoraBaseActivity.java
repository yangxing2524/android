...
import com.growalong.android.agora.openvcall.model.AgoraEngineConfig;
import com.growalong.android.agora.openvcall.model.AgoraMyEngineEventHandler;
...
public abstract class AgoraBaseActivity extends QLActivity {
    ...
    protected RtcEngine rtcEngine() {
        return MyApplication.getInstance().getWorkerThread().getRtcEngine();
    }
    ...
    protected AgoraCurrentUserSettings vSettings() {
        return MyApplication.mVideoSettings;
    }
