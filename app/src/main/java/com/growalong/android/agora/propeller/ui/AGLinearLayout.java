package com.growalong.android.agora.propeller.ui;
...
public class AGLinearLayout extends LinearLayout {
    ...
    public boolean dispatchTouchEvent(@NonNull MotionEvent event) {
        return AgoraViewUtil.checkDoubleTouchEvent(event, this) || super.dispatchTouchEvent(event);
    }

    @Override
    public boolean dispatchKeyEvent(@NonNull KeyEvent event) {
        return AgoraViewUtil.checkDoubleKeyEvent(event, this) || super.dispatchKeyEvent(event);
    }
}
