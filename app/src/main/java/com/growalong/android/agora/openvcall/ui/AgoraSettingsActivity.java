...
public class AgoraSettingsActivity extends AppCompatActivity {
    private VideoProfileAdapter mVideoProfileAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_settings_agora);
    ...
    private void initUi() {
        ...
        int prefIndex = pref.getInt(AgoraConstantApp.PrefManager.PREF_PROPERTY_PROFILE_IDX, AgoraConstantApp.DEFAULT_PROFILE_IDX);
