...
public class AgoraMyEngineEventHandler {
    public AgoraMyEngineEventHandler(Context ctx, AgoraEngineConfig config) {
        this.mContext = ctx;
        this.mConfig = config;
    }

    private final AgoraEngineConfig mConfig;
    ...
    final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandler() {
        ...
        public void onConnectionLost() {
            ...
            while (it.hasNext()) {
                AGEventHandler handler = it.next();
                handler.onExtraCallback(AGEventHandler.EVENT_TYPE_ON_APP_ERROR, AgoraConstantApp.AppError.NO_NETWORK_CONNECTION);
            }
        }
